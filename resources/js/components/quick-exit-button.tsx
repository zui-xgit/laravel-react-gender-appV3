...
const QuickExitButton = () => {
    ...
    return (
        <button
            ...
            className="group relative flex cursor-pointer items-center gap-2 overflow-hidden rounded-full bg-[#ef4444] px-5 py-2.5 text-[10px] font-black tracking-widest text-[#f8fafc] shadow-[0_0_20px_rgba(239,68,68,0.4)] transition-all hover:bg-[#f8fafc] hover:text-[#020617] hover:shadow-[0_0_30px_rgba(255,255,255,0.3)] active:scale-95"
        >
