    ...
    return (
        <div className="animate-reveal space-y-6 sm:space-y-8">
            <div className="flex items-center gap-3 sm:gap-5">
                ...
                <div className="min-w-0">
                    <h2 className="text-primary text-lg font-bold tracking-tight break-words sm:text-xl md:text-3xl">Victim Information</h2>
                    <p className="text-secondary mt-1 text-xs sm:text-sm">Details of the person affected.</p>
                </div>
            </div>
