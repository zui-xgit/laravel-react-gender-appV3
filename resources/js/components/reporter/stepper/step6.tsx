...
//         <div
//             className={`border-subtle rounded-2xl border bg-input p-4 ${spanFull ? 'sm:col-span-2' : ''}`}
//         >
//             <label className="mb-2 block text-[10px] font-black tracking-widest text-secondary uppercase">
//                 {label}
//             </label>
...
//                         )}
//                         {renderField(
//                             'Assistance Provided After Incident',
...
//                                 provided in this report is true, accurate, and
//                                 complete to the best of my knowledge. I
//                                 understand that providing false or misleading
//                                 information may result in legal consequences and
//                                 undermines the integrity of this reporting
//                                 system. I acknowledge that this report will be
//                                 reviewed and investigated by the appropriate
//                                 authorities.
//                             </span>
//                         </label>
//                     </div>
        ...
        <div className="animate-reveal space-y-8 sm:space-y-12">
            ...
            <div className="space-y-8 sm:space-y-12">
                ...
                <section className="space-y-6">
                    ...
                    {errors.confirmationChecked && (
                        <p className="mt-2 text-[10px] font-black tracking-widest text-destructive uppercase">
                            {errors.confirmationChecked}
                        </p>
                    )}
                </section>
