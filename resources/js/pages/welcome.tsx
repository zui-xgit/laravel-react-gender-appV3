...
const ScrollReveal: React.FC<{
    ...
    return (
        <div
            ref={ref}
            className={`transition-all duration-1000 ease-out ${className} ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-12 opacity-0'}`}
        >
            {children}
        </div>
    );
...
const TypewriterHeadline: React.FC = () => {
    const words = ['TANZANIA.', 'FUTURE.', 'COMMUNITY.', 'JUSTICE.'];
    ...
    return (
        <div className="flex min-h-[220px] flex-col justify-center md:min-h-0">
            <h1 className="mb-12 text-[48px] leading-[1.1] font-bold tracking-tighter text-[#f8fafc] md:text-8xl md:leading-[0.85] lg:text-[130px]">
                {/* Desktop Layout: 2 Lines. Added whitespace-nowrap to prevent "COMMUNITY" from wrapping */}
                <span className="hidden whitespace-nowrap md:block">
                    BUILDING A <br />
                    <span className="bg-gradient-to-b from-[#f8fafc] to-[#f8fafc]/30 bg-clip-text text-transparent">
                        SAFE {words[index].substring(0, subIndex)}
                    </span>
                    <span className="animate-cursor-blink ml-4 inline-block h-[0.7em] w-[4px] bg-[#3b82f6] align-middle lg:w-[6px]"></span>
                </span>

                {/* Mobile Layout: 3 Lines as requested */}
                <span className="block md:hidden">
                    ...
                    <span className="animate-cursor-blink ml-2 inline-block h-[0.7em] w-[3px] bg-[#3b82f6] align-middle"></span>
                </span>
            </h1>
        </div>
    );
...
const Welcome: React.FC = () => {
    ...
    const scrollToSection = (targetId: string) => {
        ...
        const targetElement = document.querySelector<HTMLElement>(cleanId);
        ...
        if (targetElement) {
            ...
            // Removed pushState to avoid breaking Inertia links
        }
    };
    ...
    // every time the user visits this page, reset the form to clear all data from the local storage
    useEffect(() => {
        resetForm();
    }, []);

    return (
        <div className="font-inter relative min-h-screen overflow-x-hidden bg-[#020617] text-[#f8fafc] selection:bg-[#3b82f6]/50 selection:text-[#f8fafc]">
            {/* <Assistant /> */}
      ...
      `}</style>
            ...
            {/* Navigation - Fixed "ugly white line" by removing border and using subtle shadow */}
            <nav
                className={`fixed top-0 right-0 left-0 z-50 border-none transition-all duration-500 ${
                    scrolled
                        ? 'bg-[#020617]/80 py-4 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-2xl'
                        : 'bg-transparent py-6'
                }`}
            >
                <div className="mx-auto flex max-w-7xl items-center justify-between px-6">
                    <div className="flex items-center gap-10">
                        <div className="group flex cursor-pointer items-center gap-2.5">
                            <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-[#f8fafc] text-[#020617] shadow-[0_0_20px_rgba(248,250,252,0.2)] transition-transform duration-500 group-hover:rotate-[15deg]">
                                <Shield size={20} />
                            </div>
                            <span className="font-bebas text-2xl tracking-[0.15em] text-[#f8fafc]">
                                PAZA SAUTI
                            </span>
                        </div>
                        ...
                        <div className="hidden items-center gap-8 lg:flex">
                            {NAV_ITEMS.map((item) => (
                                <button
                                    ...
                                    className="cursor-pointer text-[11px] font-bold tracking-widest text-[#94a3b8] uppercase transition-colors hover:text-[#f8fafc]"
                                >
                                    {item.label}
                                </button>
                            ))}
            ...
            <main className="relative z-10">
                ...
                <section
                    id="hero"
                    className="relative flex min-h-screen w-full items-center justify-center overflow-hidden pt-32 pb-40"
                >
                    <AnimatedBackground />
                    <div className="relative z-10 mx-auto max-w-7xl px-6 text-center">
                        <ScrollReveal>
                            <div className="mb-10 inline-flex items-center gap-2 rounded-full border border-[#f8fafc]/10 bg-[#f8fafc]/5 px-4 py-1.5 text-[10px] font-bold tracking-[0.2em] text-[#3b82f6] uppercase">
                                <Lock size={12} />
                                Secure Anonymous Protocol V3.0
                            </div>

                            <TypewriterHeadline />

                            <p className="mx-auto mb-16 max-w-2xl text-xl leading-relaxed font-light tracking-tight text-[#94a3b8] md:text-2xl">
                                A purpose-built interface for gender justice.
                                Secure reporting, regional intelligence, and
                                direct support connections.
                            </p>

                            {/* Fixed button jitter/enlargement by ensuring flex-shrink and stable parent height above */}
                            <div className="flex flex-col items-center justify-center gap-6 sm:flex-row">
                                ...
                                <button className="flex w-full flex-shrink-0 cursor-pointer items-center gap-2 rounded-2xl border border-[#f8fafc]/10 px-8 py-4 text-sm font-bold text-[#94a3b8] transition-colors hover:bg-[#f8fafc]/5 hover:text-[#f8fafc] sm:w-auto">
                                    Privacy Protocols
                    ...
                    <div className="absolute right-0 bottom-0 left-0 z-10 h-32 bg-gradient-to-t from-[#020617] to-transparent" />
                </section>

                {/* Emergency Grid Section */}
                <section
                    id="emergency"
                    className="mx-auto mb-52 max-w-7xl px-6 pt-24"
                >
                    <ScrollReveal>
                        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
                            {HOTLINES.map((hotline) => (
                                <a
                                    ...
                                    className="glass-card group relative flex h-[340px] flex-col justify-between rounded-[40px] border border-[#f8fafc]/10 p-12 transition-all duration-500 hover:-translate-y-4 hover:scale-[1.02] hover:border-[#3b82f6]/50 hover:shadow-[0_20px_50px_rgba(59,130,246,0.1)]"
                                >
                                    <div className="relative z-10 flex items-start justify-between">
                                        <div className="flex h-14 w-14 items-center justify-center rounded-2xl bg-[#f8fafc]/10 shadow-inner transition-all duration-500 group-hover:bg-[#3b82f6] group-hover:text-[#f8fafc]">
                                            <Phone
                                                size={28}
                                                className="text-[#f8fafc]"
                                            />
                                        </div>
                                        <div className="rounded-full border border-[#3b82f6]/20 bg-[#3b82f6]/10 px-3 py-1 text-[10px] font-black tracking-[0.2em] text-[#3b82f6] uppercase">
                                            Active Now
                                        </div>
                                    </div>
                                    <div className="relative z-10">
                                        <div className="mb-2 text-5xl font-black tracking-tighter transition-colors duration-300 group-hover:text-[#3b82f6]">
                                            {hotline.number}
                                        </div>
                                        <div className="mb-3 text-sm font-bold tracking-[0.15em] text-[#f8fafc] uppercase">
                                            {hotline.label}
                                        </div>
                                    ...
                                    <div className="absolute inset-0 rounded-[40px] bg-gradient-to-br from-[#3b82f6]/5 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
                                </a>
                            ))}
                        </div>
                    </ScrollReveal>
                ...
                {/* Intelligence / Trust Block */}
                <section id="privacy" className="mx-auto mb-52 max-w-7xl px-6">
                    <ScrollReveal>
                        <div className="glass-card relative overflow-hidden rounded-[64px] border border-[#f8fafc]/10 p-12 md:p-32">
                            <div className="absolute top-0 right-0 -mt-64 -mr-64 h-[600px] w-[600px] rounded-full bg-[#3b82f6]/10 blur-[120px]" />
                            <div className="relative z-10 grid grid-cols-1 items-center gap-24 lg:grid-cols-2">
                                <div>
                                    <h2 className="mb-10 text-5xl leading-[0.9] font-bold tracking-tighter md:text-7xl">
                                        YOUR DATA <br />
                                        <span className="text-[#f8fafc]/40 italic">
                                            NEVER LEAVES.
                                        </span>
                                    </h2>
                                    <p className="mb-14 text-xl leading-relaxed font-light text-[#94a3b8]">
                                        Zero-knowledge encryption ensures your
                                        identity is mathematically impossible to
                                        retrieve, even for us.
                                    </p>
                                    <div className="grid grid-cols-1 gap-8">
                                        {[
                                            ...
                                            >
                                                <div className="flex h-10 w-10 items-center justify-center rounded-xl border border-[#f8fafc]/20 transition-all group-hover:border-transparent group-hover:bg-[#3b82f6]">
                                                    <ShieldCheck
                                                        size={22}
                                                        className="text-[#94a3b8] group-hover:text-[#f8fafc]"
                                                    />
                                                </div>
                                                <span className="text-lg font-medium text-[#94a3b8] transition-colors group-hover:text-[#f8fafc]">
                                                    {item}
                                                </span>
                                            </div>
                                        ))}
                                ...
                                <div className="space-y-8">
                                    <div className="glass-card flex items-center justify-between rounded-[40px] p-10 transition-all hover:border-[#3b82f6]/30">
                                        <div>
                                            <div className="mb-2 text-xs font-black tracking-widest text-[#f8fafc]/40 uppercase">
                                                Security Status
                                            </div>
                                    ...
                                    <div className="glass-card rounded-[40px] p-10 transition-all hover:border-[#3b82f6]/30">
                                        <div className="mb-4 text-xs font-black tracking-widest text-[#f8fafc]/40 uppercase">
                                            Anonymity Layer
                                        </div>
                                        <div className="flex gap-2">
                                            {[1, 2, 3, 4, 5].map((i) => (
                                                <div
                                                    key={i}
                                                    className="h-2 flex-1 animate-pulse rounded-full bg-[#3b82f6] opacity-60"
                                                    style={{
                ...
                {/* Regional Desks */}
                <section id="desks" className="mx-auto mb-52 max-w-5xl px-6">
                    <ScrollReveal>
                        <div className="mb-16 text-center">
                            ...
                            <p className="text-[#94a3b8]">
                                Connected to every Gender Desk across the United
                                Republic of Tanzania.
                            </p>
                        </div>
                        <div className="grid grid-cols-1 gap-1 px-4 sm:grid-cols-2 lg:grid-cols-3">
                            {GENDER_DESKS.map((desk) => (
                                <div
                                    key={desk.region}
                                    className="group flex cursor-default items-center justify-between border-b border-[#f8fafc]/10 px-6 py-8 transition-all hover:bg-[#f8fafc]/5"
                                >
                                    <div>
                                        <h4 className="text-lg font-bold text-[#f8fafc] transition-colors group-hover:text-[#3b82f6]">
                                            {desk.region}
                                        </h4>
                                    ...
                                    <MapPin
                                        size={20}
                                        className="text-[#f8fafc]/30 transition-colors group-hover:text-[#f8fafc]"
                                    />
                                </div>
                            ))}
                        </div>
                ...
                >
                    <ScrollReveal>
                        <div className="mb-16">
                            <Heart
                                size={48}
                                className="mx-auto mb-8 text-[#3b82f6]"
                            />
                            <h2 className="mb-12 text-6xl leading-none font-bold tracking-tighter md:text-9xl">
                                RAISE YOUR <br />
                                <span className="bg-gradient-to-r from-[#3b82f6] to-[#f8fafc] bg-clip-text text-transparent">
                                    VOICE.
                                </span>
                            </h2>
                        </div>
                        ...
                        >
                            ...
                            <ChevronRight
                                size={32}
                                className="ml-2 inline transition-transform group-hover:translate-x-2"
                            />
                        </Link>
                        <p className="mt-12 text-[10px] font-black tracking-[0.5em] text-[#f8fafc]/40 uppercase">
                            Tanzania National Security Protocol
                        </p>
                    </ScrollReveal>
                </section>
            </main>
            ...
            <footer
                id="footer"
                className="relative z-20 border-t border-[#f8fafc]/10 bg-[#020617] px-6 py-32"
            >
                <div className="absolute top-0 left-1/2 h-[1px] w-full max-w-7xl -translate-x-1/2 bg-gradient-to-r from-transparent via-[#f8fafc]/20 to-transparent" />
                <div className="mx-auto grid max-w-7xl grid-cols-1 gap-20 md:grid-cols-2 lg:grid-cols-4">
                    <div className="lg:col-span-1">
                        <div className="mb-8 flex items-center gap-3">
                            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#f8fafc] text-[#020617]">
                                <Shield size={18} />
                            </div>
                        ...
                        <p className="text-sm leading-relaxed font-medium text-[#94a3b8]">
                            A sovereign secure platform for human dignity. Built
                            for the the people of Tanzania through next-gen
                            security.
                        </p>
                    </div>
                    <div className="grid grid-cols-2 gap-16 sm:grid-cols-3 lg:col-span-3">
                        <div>
                            <h5 className="mb-8 text-[10px] font-black tracking-[0.3em] text-[#f8fafc]/30 uppercase">
                                Resources
                            </h5>
                            <ul className="space-y-5 text-sm font-semibold text-[#94a3b8]">
                                <li>
                                    <a
                                        href="#"
                ...
                <div className="mx-auto mt-32 flex max-w-7xl flex-col items-center justify-between gap-8 border-t border-[#f8fafc]/10 pt-32 text-[10px] font-black tracking-[0.4em] text-[#f8fafc] uppercase opacity-40 md:flex-row">
                    <p>© 2025 PAZA SAUTI TANZANIA. ALL RIGHTS RESERVED.</p>
