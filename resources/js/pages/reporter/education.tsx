            ...
            <div className="flex flex-col gap-16 py-12 md:py-20">
                ...
                <section className="mx-auto flex max-w-3xl flex-col items-center gap-6 px-4 text-center">
                    ...
                    <p className="text-lg text-muted-foreground">
                        Understanding gender-based violence is the first step
                        toward prevention. Explore our resources to learn about
                        your rights, available support, and how to stay safe.
                    </p>
                </section>
                    ...
                    <div className="mx-auto flex w-full max-w-4xl flex-col gap-10 px-4">
                        <div className="flex flex-col gap-3">
                            ...
                            <p className="max-w-2xl text-muted-foreground">
                                You are protected by both institutional policy
                                and national laws. Familiarize yourself with
                                these rights to ensure you are treated fairly
                                and safely.
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 items-center gap-12 md:grid-cols-2">
                        <div className="space-y-6">
                            ...
                            <p className="text-muted-foreground">
                                Taking the right steps after an incident can
                                help ensure your safety and make the reporting
                        ...
                        <div className="relative p-8 md:p-12">
                            <div className="relative z-10 flex flex-col items-center gap-6 text-center">
                                ...
                                <p className="max-w-xl text-primary-foreground/80">
                                    ...
                                    by gender-based violence, do not hesitate to
                                    seek help or report the incident. Your voice
                                    matters.
                                </p>
